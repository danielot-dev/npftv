...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticRoutes: MetadataRoute.Sitemap = [
    ...
    { url: `${BASE_URL}/find-a-police-station`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE_URL}/crime-prevention`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE_URL}/stats-and-data`, changeFrequency: "monthly", priority: 0.5 },
    { url: `${BASE_URL}/report`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${BASE_URL}/partners`, changeFrequency: "monthly", priority: 0.4 },
  ];
